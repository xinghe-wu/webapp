<template>
  <div class="my-fm-list">
    <van-nav-bar
      ...
      title="栏目选择"
    >
      <a v-show="!editable" class="header-button" slot="right">添加</a>
    ...
    <div class="edit-toolbar" v-show="editable">
      ...
      <div class="btns">
        <!-- <a href="javascript:;" class="btn-remove" @click="onRemove">
          ...
          删除</a
        > -->
        <a href="javascript:;" @click="onRemove" class="btn-ok">提交</a>
      </div>
    </div>
    <!-- <div class="content">
                <ul class="list">
    ...
    <pull-to :bottom-load-method="refresh">
      <div class="aui-content aui-margin-b-15 ">
        <ul
          ...
          v-for="(l, index) in fm_list"
          @click="onSelect(l.id)"
        >
          <li class="aui-list-item aui-list-item-middle">
            <div class="aui-media-list-item-inner">
              <span v-show="!editable" @click="sote()">{{ index + 1 }}</span>
              <van-icon
                v-show="editable"
              ...
              <div class="aui-list-item-inner all-ancho-list-inner">
                <div class="aui-list-item-text">
                  ...
                  <div class="aui-list-item-right">
                    <div v-if="l.free === 1" class="btn-follow">
                      ￥{{ l.money }}
                    </div>
                  </div>
                </div>
