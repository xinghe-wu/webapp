...
<!-- <div class="header1">
	<div class="aui-row">
	   ...
	   <div class="aui-col-xs-9 "  style="text-align:left">
			    李艺宁
		</div>

		<div class="aui-col-xs-2" >
     	<span class="aui-btn ">已关注</span>
	 </div>
	...
	<div class="anchor">
   	...
   	<div class="aui-card-list"  v-for="i in infoList">
			...
			<div class="aui-card-list-footer aui-border-t footer-list" >
					<div>	<img class="img" src="../../../../assets/images/radio/like.png" /><span class="title-check">{{i.zans}}</span></div>
...
import { src, getCompereById, getInfos } from '../../index/services';
